...
class AppState with ChangeNotifier {
  ...
  Set<Polyline> get polyLines => polyLines;
  ...
  get autoCompleteContainer => null;

  set selectedPlace(selectedPlace) {}

  set autoCompleteContainer(bool autoCompleteContainer) {}
...
// ! TO CREATE ROUTE
  ...
  void onAddMarker(LatLng location, String address) {
...
// ! ON CAMERA MOVE
  ...
  void visibilityAutoComplete(bool param0) {}
...
class _polyLines {
  static void any(Polyline polyline) {}
}
